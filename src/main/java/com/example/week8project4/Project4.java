...
public class Project4 extends Application {
    ...
    public void start(Stage stage) throws IOException {
       ...
       // using xml file:
       // Parent root = FXMLLoader.load(getClass().getResource("com/example/week8project4/layout.fxml")); // changed from "layout.fxml"
        ...
        // without using .fxml file:
//        Scene scene = new Scene(grid, 400, 250);
//        stage.setScene(scene);
//        stage.show();

// fixed the error WARNING: Loading FXML document with JavaFX API of version 23.0.1 by JavaFX runtime of version 22.0.1
// by updating the javafx runtime version in the project structure, removing all 22.0.1 references and adding 23.0.1 references
// by adding the lib folder to the project structure
// to print javafx version: System.out.println(System.getProperty("javafx.runtime.version"));
...
/*manual creation of ui and button evennt hanbdlers
...
//            String[] interval2EndHoursMinutes = interval2End.split(":");
            ...
            System.out.println("variables for interval1Start: " + "HOURS:" + interval1StartHours + " MINUTES: " + interval1StartMinutes + " MERIDIAN: " + interval1StartMeridian);
